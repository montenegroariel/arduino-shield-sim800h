...
class GetHandler(BaseHTTPRequestHandler):
	...
	send_message(encode_phn(phone),encode_msg("El equipo Nro " + number + " ha superado su limite de temperatura registrando " + temperature + ". Por favor verifique su funcionamiento."))
        self.end_headers()
        return
